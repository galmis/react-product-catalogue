...
const Venostrong = () => {
  return (
    <div>
      <p>VenoStrong gali pa&scaron;alinti sunkumą kojose, jų tinimą, kraujagyslių "žvaigždučių" susidarymą ir gali kovoti su lėtiniu venų nepakankamumu.</p>
      ...
      <div>
        ...
        <ul className="list-featured">
          <li>Mažina kojų tinimą.</li>
          <li>Mažina lėtinio venų nepakankamumo požymius.</li>
          <li>Padeda išvengti skausmo, sunkumo ir silpnumo kojose.</li>
          <li>Padeda išvengti kraujagyslių "žvaigždučių" susidarymo.</li>
          <li>Gali atstatyti ir sustiprinti kraujagyslių sieneles.</li>
          <li>Padeda išvengti mėšlungio kojose.</li>
        ...
        <ul className="list-featured">
          ...
          <li>Tie, kurie jaučia diskomfortą blauzdose, ir kuriuos naktimis kamuoja kojų raumenų mėšlungis.</li>
          <li>Tie, kurie ilgą laiką stovi arba sėdi vienoje vietoje.</li>
          <li>Moterys, kurios avi aukštakulnius.</li>
          <li>Tie, kurie linkę sirgti širdies-kraujagyslių ligomis.</li>
          <li>Visos moterys, nes jų hormonų svyravimai gali sukelti lėtinį venų nepakankamumą.</li>
          <li>Tie, kurie mažai sportuoja.</li>
          <li>Tie, kurie turi antsvorį.</li>
          <li>Tie, kurie rūko arba neseniai metė rūkyti.</li>
        </ul>

        <strong>Sudėtis:</strong> <p></p>
        <ul className="list-featured">
          <li>Apelsinų vaisių ekstraktas</li>
          <li>Vynuogių išspaudų ekstraktas</li>
          <li>Citrusinių vaisių žievelių ekstraktas</li>
          <li>Standartizuotas gotų kolos ekstraktas</li>
          <li>Papajos ekstraktas</li>
        </ul>
      </div>
    </div>
  );
