...
const StalonNeo = () => {
  return (
    <div>
      ...
      <p>Dviskiautis ginkmedis turi galingų antioksidantų – ginkolidų ir bilobalidų, kurie didina kraujagyslių sienelių elastingumą. Dviskiautis ginkmedis ne tik plečia smegenų ir periferines kraujagysles, bet ir pagerina kraujo tiekimą į mažojo dubens organus.</p>
      <p>Vyriškų augalinių komponentų puokštę papildo imbieras ir kokos medis. Imbiero sudėtyje yra vitaminų ir medžiagų, kurių organizmas pats nesintezuoja, o gauna iš išorės. Šios medžiagos paspartina medžiagų apykaitą, skatina kraujo tekėjimą greičiau, suteikia organizmui gyvybingumo, todėl labai teigiamai veikia vyrų sveikatą. Imbieras ir kokos medis – stiprūs tonizuojantys augalai, kurie gali atkurti vyrų potenciją, grąžinti fizines jėgas bei padidinti libido.</p>
      <p>Efektyviausiai įsisavinti augalinius komponentus ir padidinti seksualinę ištvermę padeda vitaminų ir cinko kompleksas, kuris su vitaminu B1 atlieka svarbų vaidmenį išsaugant gerą reprodukcinę funkciją.</p>
      <p>Galingas antioksidantas vitaminas E apsaugo ląstelių membranų lipidus nuo žalingo laisvųjų radikalų poveikio ir sumažina uždegiminių procesų dinamiką. Vitaminas E aktyviai veikia endogeninio testosterono metabolizmą ir padeda išlaikyti normalią jo sintezę bei biologinį poveikį. Kartu su vitaminu PP jis reguliuoja reprodukcinęfunkciją ir gerina potenciją.</p>
      <div>
        <br />
        <strong>Savybės:</strong> <p></p>
        <ul className="list-featured">
          <li>Didina potenciją ir gerina erekciją.</li>
          <li>Stimuliuoja seksualinį aktyvumą, didina libido.</li>
          <li>Veikia stiprinamai ir tonizuojančiai.</li>
          <li>Didina seksualinę ištvermę, gerina seksualinį gyvenimą, pratęsia lytinį aktą.</li>
          <li>Augalinai afrodiziakai veikia švelniai, palaipsniui reguliuodami erekcijos funkciją, padidindami potenciją ir padėdami ilgam laikui įtvirtinti per 20 dienų pasiektą efektą.</li>
        ...
        <ul className="list-featured">
          ...
          <li>Vyrai, kurie nori praturtinti seksualinius pojūčius, prailginti lytinį aktą.</li>
          <li>Vyrai, kurie vartoja alkoholį ir rūko.</li>
          <li>Vyrai, kurie dažnai patiria stresus.</li>
          <li>Vyrai, kurie patiria didelį fizinį ir emocinį krūvį.</li>
        </ul>
      </div>
    </div>
  );
