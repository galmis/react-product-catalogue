...
const Lamin = () => {
  return (
    <div>
      ...
      <p>L-karnitinas atlieka svarbiausią vaidmenį spermos metabolizme, užtikrindamas energijos, kuri yra būtina spermatozoidų judėjimui, brendimui ir genezei, tiekimą. Kartu su dygliuotuoju eleuterokoku ir vitaminu C, L-karnitinas gerokai pagerina spermatozoidų judrumą, jų koncentraciją, spermos kiekį, ir, kas labai svarbu, apvaisinimo tikimybę. Jis pagerina baltymų ir riebalų apykaitą, padidina atsparumą fizinei įtampai. Be to, L-karnitinas ir vitaminas C apsaugo spermą nuo oksidacijos žalos. Yra svarbus erekcijos disfunkcijos atveju. L-karnitinas yra veiksminga priemonė, neleidžianti mažėti hormonų kiekiui. L-karnitinas padidina energijos gamybą organizme, taip mažindamas polinkį į nuovargį ir didindamas darbingumą bei fizines galimybes.L-karnitinas nėra stimuliatorius, jo poveikis organizmui pasireiškia kitaip: jis pagerina energijos apykaitą kiekvienoje ląstelėje, padidinaenergijos gamybą organizme ir todėl suteikia ilgalaikį poveikį. Jis nesukelia priklausomybės, nes tai yra natūrali organizmo medžiaga.</p>
      <div>
        <br />
        <strong>Savybės:</strong> <p></p>
        <ul className="list-featured">
          <li>Gali veikti stiprinamai ir tonizuojančiai.</li>
          <li>Gali didinti darbingumą ir mažinti nuovargį.</li>
          <li>Veikia stiprinamai ir tonizuojančiai.</li>
          <li>Reikalingas patiriant didelį fizinį, emocinį ir protinį krūvį.</li>
          <li>Padeda skatinti natūralaus testosterono gamybą.</li>
          <li>Gali padėti gerinti reprodukcinę funkciją, didinti spermatozoidų skaičių, judrumą ir gebėjimą apvaisinti.</li>
          <li>Turi adaptogeninių savybių.</li>
        ...
        <ul className="list-featured">
          ...
          <li>Vyrai, kurie geria daug kavos, vartoja alkoholį ir rūko.</li>
          <li>Vyrai, kurie patiria nervinį išsekimą ir stresą dėl sunkaus emocinio išsekimo.</li>
          <li>Sportininkai, kurie nori pagerinti ištvermę ir patiria didelį fizinį krūvį.</li>
          <li>Vyrai, kurie rūpinasi savo sveikata, nori išsaugoti gyvybingumą.</li>
        </ul>
      </div>
    </div>
  );
